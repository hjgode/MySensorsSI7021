...
#define CHILD_ID_HUM 1
    ...
    #define BATTERY_REPORT_CYCLE 2  // Once per 5min   =>   12*24*7 = 2016 (one report/week)
#else
...
void loop(){
  DEBUG_PRINT("### sendTempHumidityMeasurements (loop())...");
  sendTempHumidityMeasurements(true);
  wait(3000);
}
void presentation /*loop*/() { 
  ...
  DEBUG_PRINT("measureCount/FORCE_TRANSMIT_CYCLE: ");
  DEBUG_PRINT(measureCount);   DEBUG_PRINT("/");
  DEBUG_PRINTLN(FORCE_TRANSMIT_CYCLE);
